...
public class PublicPlaylistDetailsRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context context;
    ArrayList<String> songIdsList = new ArrayList<>();
    Playlist playlist;

    public PublicPlaylistDetailsRecyclerAdapter(Context ctx) {
        this.context = ctx;
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        ((MiscellaneousAdapterHolder) holder).imageViewMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                popupMenu.getMenuInflater().inflate(R.menu.public_playlists_details_pop_up_menu, popupMenu.getMenu());
                popupMenu.show();
